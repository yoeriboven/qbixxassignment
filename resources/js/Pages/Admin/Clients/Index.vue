                        ...
                        <tr v-for="client in clients" :key="client.id" class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                            ...
                            <td class="w-4/12 text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                <div class="flex space-x-2 justify-end">
                                    <Link :href="'/admin/clients/' + client.id" class="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 py-0 px-1" href="#" title="View on front-end">
                                    ...
                                    <Link :href="'/admin/clients/' + client.id + '/edit'" class="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 py-0 px-1" title="Edit">
